...
public class LoanWheelRecycle {
	...
	// Wheel view
	private LoanWheelView wheel;
	
	/**
	 * Constructor
	 * @param wheel the wheel view
	 */
	public LoanWheelRecycle(LoanWheelView wheel) {
		this.wheel = wheel;
	}
	 ...
	 */
	public int recycleItems(LinearLayout layout, int firstItem, LoanItemsRange range) {
		int index = firstItem;
